...
function renderWhiteSauce() {
  ...
  let sauceWhite = document.querySelector('section.sauce');
  if (!state.whiteSauce) {
...
function renderGlutenFreeCrust() {
  ...
  let glutenCrust = document.querySelector('section.crust');
...
function renderButtons() {
  ...
  for (const key in state) {
    const activeBtn = document.querySelector(`.${stateButtons[key]}`);
...
function renderPrice() {
  ...
  const pepperoniPrice = document.querySelector('aside #pepperoni');
  console.log(pepperoniPrice);
  let calculatePrice;
  pepperoniPrice.textContent = '$ peperoni';
}
